...
<%
  ...
  String Id = (String)session.getAttribute("ouserid");
  while(RS_result.next())//RS_result.next()
  {
    ...
    if(Uname.equals(Name) && pass0.equals(Pass) && Id.equals(uu)){
      System.out.println(uu);
      if(pass1.equals(pass2)){
        try{
          String sql = "update users set passwords="+pass2+" where userid="+uu+";";
